...
builder.Services.AddAuthorization(); // cấu hình phân quyền
...
var userManager = scope.ServiceProvider.GetRequiredService<UserManager<User>>(); // cấu hình cho UserManager<User>
